...
//合作身份者ID，以2088开头的16位纯数字
  ...
  $partner		= "2088102928539379";

//安全检验码，以数字和字母组成的32位字符
 $key   			= "l6mczym8h9118d5ljgcvzs0dpqg8ao7b";

//签约支付宝账号或卖家支付宝帐户
 $seller_email	= "freemanfreelift@gmail.com";

//交易过程中服务器通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
 $notify_url		= "http://www.minwwls.com/services/alipay/notify_url.php";

//付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
 $return_url		= "http://www.minwwls.com/services/alipay/return_url.php";
